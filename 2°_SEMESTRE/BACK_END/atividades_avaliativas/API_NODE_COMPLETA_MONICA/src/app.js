...
app.get("/exemplar/:idExemplar", (req,res) =>{
    const index = buscarExemplar(req.params.idExemplar)
...
app.put("/exemplar/:idExemplar", (req,res) =>{
    const index = buscarExemplar(req.params.idExemplar)

    exemplar[index].nomeAutor = req.body.nomeAutor
    exemplar[index].nacionalidade = req.body.nacionalidade

    res.status(200).json(exemplar[index])
})

app.delete("/exemplar/:idExemplar", (req,res) =>{
    const index = buscarExemplar(req.params.idExemplar)
