...
function inicializarVitrine(){
    ...
    //3.2 AÇÃO DO BTN PEDIDO
        if (clicado.classList.contains("btn-pedido")){
            ...
            setTimeout(function(){ //Acabei de clicar no botão, quanto tempo ele vai se fixar até sumir?
            ...
            if(box){ //se o box nem está adicionado
                box.querySelector('quantidade-valor').textContent = "1" //tem q estar em texto pq a função criada anteriormente já converte, ent precisamos dar o valor correto para ela
                atualizarPrecoCard(box)
            }
